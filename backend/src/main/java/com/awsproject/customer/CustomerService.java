package com.awsproject.customer;

import com.awsproject.exception.DuplicateResourceException;
import com.awsproject.exception.RequestValidationException;
import com.awsproject.exception.ResourceNotFoundException;
...
public class CustomerService {
    ...
    public void deleteCustomerById(Integer customerId) {
        ...
        System.out.printf("profile-images/%s/", customerId);
        System.out.println("\n");
        ...
        s3Service.deleteObject(s3Buckets.getCustomer(), "profile-images/%s".formatted(customerId));
    ...
    public void uploadCustomerProfileImage(Integer customerId, MultipartFile file) {
        ...
        String oldProfileImageId = customer.profileImageId();

        s3Service.deleteObject(s3Buckets.getCustomer(), "profile-images/%s/%s".formatted(customerId, oldProfileImageId));
