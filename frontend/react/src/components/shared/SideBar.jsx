...
import {customerProfilePictureUrl, getCustomerByEmail} from "../../services/client.js";
...
const SidebarContent = ({onClose, ...rest}) => {
    return (
        <Box
            ...
            h="full"
            {...rest}>
            <Flex h="20" flexDirection="column" alignItems="center" mx="8" mb={-5} mt={2} justifyContent="space-between">
...
const MobileNav = ({ onOpen, ...rest }) => {
    ...
    useEffect(() => {
        const fetchCustomerDetails = async () => {
            const user = await getCustomerByEmail(customer?.username);
            setEmail(user?.email || '');
            setProfilePictureUrl(customerProfilePictureUrl(user?.id));
        };
                        ...
                        >
                            <HStack>
                                ...
                                <VStack
                                    ...
                                    ml="2"
                                >
                                    <Text fontSize="sm">{email || customer?.username}</Text>
